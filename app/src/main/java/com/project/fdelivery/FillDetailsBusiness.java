...
public class FillDetailsBusiness extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fill_detailes);
    ...
    private void handleConnect() {
        ...
        call.enqueue(new Callback<Business>() {
            ...
            public void onFailure(Call<Business> call, Throwable t) {
                Toast.makeText(FillDetailsBusiness.this, "Something went wrong", Toast.LENGTH_LONG).show();
            }
        });
    }
}
